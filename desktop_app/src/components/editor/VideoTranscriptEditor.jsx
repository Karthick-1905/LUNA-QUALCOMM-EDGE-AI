...
import { Edit3, Check, X, MessageSquare, Clock } from 'lucide-react';
...
const VideoTranscriptEditor = ({ 
  ...
  // Get speaker - handle both speaker objects and speaker IDs
  const getSpeaker = useCallback((speaker) => {
    if (typeof speaker === 'object' && speaker !== null) {
      return speaker; // Already a speaker object
    }
    // If it's a speaker ID, find the speaker
